...
export default function App() {
  ...
  const [tempDescription, setTempDescription] = useState('') // Input temporário de texto para descrição
  const [newPersonName, setNewPersonName] = useState('') // Input de texto para nome da pessoa
